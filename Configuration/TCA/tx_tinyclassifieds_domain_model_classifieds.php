    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_tinyclassifieds_domain_model_classifieds',
                'foreign_table_where' => 'AND {#tx_tinyclassifieds_domain_model_classifieds}.{#pid}=###CURRENT_PID### AND {#tx_tinyclassifieds_domain_model_classifieds}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => false,
            'label' => 'LLL:EXT:tinyclassifieds/Resources/Private/Language/locallang_db.xlf:tx_tinyclassifieds_domain_model_classifieds.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required',
        ...
        'author' => [
            'exclude' => true,
            'label' => 'LLL:EXT:tinyclassifieds/Resources/Private/Language/locallang_db.xlf:tx_tinyclassifieds_domain_model_classifieds.author',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
